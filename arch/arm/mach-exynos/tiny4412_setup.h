...
#define DIV_STAT_TOP_CHANGING  (ACLK400MCUISP_RATIO(DIV_STAT_CHANGING) | \
								ACLK266GPS_RATIO(DIV_STAT_CHANGING) | \
								ONENAND_RATIO(DIV_STAT_CHANGING) | \
								ACLK133RATIO(DIV_STAT_CHANGING) | \
								ACLK160RATIO(DIV_STAT_CHANGING) | \
								ACLK100RATIO(DIV_STAT_CHANGING) | \
								ACLK200RATIO(DIV_STAT_CHANGING))
