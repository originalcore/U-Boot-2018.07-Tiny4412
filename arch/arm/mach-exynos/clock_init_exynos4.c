...
void system_clock_init(void)
{
   ...
   */
   ...
   clr = ACLK400MCUISP_RATIO(7) | ACLK200RATIO(7) | ACLK266GPS_RATIO(7) |
               ACLK100RATIO(15) | ACLK160RATIO(7) | ACLK133RATIO(7) |ONENAND_RATIO(7);
   set = ACLK400MCUISP_RATIO(1) | ACLK200RATIO(4) | ACLK266GPS_RATIO(2) |
               ACLK100RATIO(7)  | ACLK160RATIO(4) | ACLK133RATIO(5) |ONENAND_RATIO(1);
   ...
   */
   ...
   clr = MUX_EPLL_SEL(1) | MUX_VPLL_SEL(1) | MUX_ACLK200SEL(1) |
           MUX_ACLK100SEL(1) | MUX_ACLK160SEL(1) |
           MUX_ACLK133SEL(1) | MUX_ONENAND_SEL(1) | MUX_ONENAND1SEL(1);

   set = MUX_EPLL_SEL(1) | MUX_VPLL_SEL(1) | MUX_ACLK200SEL(0) |
           MUX_ACLK100SEL(0) | MUX_ACLK160SEL(0) |
           MUX_ACLK133SEL(0) | MUX_ONENAND_SEL(0) | MUX_ONENAND1SEL(0);
   ...
   clr = MUX_MPLL_USER_SEL_T(1) | MUX_ACLK400MCUISP_SEL(1) |
           MUX_ACLK400MCUISP_SUB_SEL(1) | MUX_ACLK200SUB_SEL(1) |
           MUX_ACLK266GPS_SEL(1) | MUX_ACLK266GPS_SUB_SEL(1);

   set = MUX_MPLL_USER_SEL_T(1) | MUX_ACLK400MCUISP_SEL(0) |
           MUX_ACLK400MCUISP_SUB_SEL(1) | MUX_ACLK200SUB_SEL(1) |
           MUX_ACLK266GPS_SEL(0) | MUX_ACLK266GPS_SUB_SEL(1);
